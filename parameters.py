...
class Parameters:
    ...
    The function to calculate the porosity
       use calculate_porosity_w_median_plus_1 for calculateion with the median 
    """
    # todo rename and push old porosity functions to archive, and/or use an object for function
