...
def calculate_porosity(pixel_below_threshold, flat_grayscale_image, verbose=False):
...
def calculate_porosity_w_threshold(flat_grayscale_image, threshold=200, verbose=False) -> float:
    ...
    return calculate_porosity(pixel_below_threshold, flat_grayscale_image, verbose)
